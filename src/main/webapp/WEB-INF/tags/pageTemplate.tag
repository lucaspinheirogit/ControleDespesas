...
<link rel="shortcut icon"
	href="${contextPath}resources/imagens/favicon.png" />
...
<link rel="stylesheet"
	href="${contextPath}resources/css/responsive-table.css" />
	...
	<div class="container-fluid">
		...
		<div id="voltar" class="container p-2">
			<a style="background-color: #3c546d"
				href="${s:mvcUrl('HC#index').build() }" class="btn btn-primary">Voltar</a>
		</div>

		<jsp:doBody />
	</div>
	<footer>
		<h6 style="text-align: center">Desenvolvido por Lucas Pinheiro
			&copy</h6>
	</footer>
